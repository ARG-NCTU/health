...
def listener():
    ...
    pub = rospy.Publisher('health/_zedtower_mid', String, queue_size=10)
    while not rospy.is_shutdown():
        healthstring = '_zedtower_mid@' + HealthStatus[0] + ':' + HealthStatus[1] + ':' + HealthStatus[2] + ':0:0:0:0'
        print(healthstring)
